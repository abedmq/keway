...
<head>
    ...
    <title>GRAPE - Multipurpose App Landing Template</title>
    ...
    <link rel="stylesheet" href="front/assets/css/et-line.css">
    ...
    <link rel="stylesheet" href="front/assets/css/plyr.css">
    ...
    <link rel="apple-touch-icon" sizes="72x72" href="front/images/icon-72x72.png">
    <link rel="apple-touch-icon" sizes="114x114" href="front/images/icon-114x114.png">
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">
                <img src="front/images/logo.png" alt="Site Logo">
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav navbar-right" id="one-page-nav">
                ...
                <li><a href="#description">Why best</a></li>
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="banner-text-content">
                            <h1 class="banner-title">Present your awesome app <br/>using Grape</h1>
                            <p class="banner-text">Available in App Store &amp; Google Play</p>
                            <div class="button-group">
                                <a class="btn btn-lg" href="#">Learn More</a>
                                <a class="btn btn-lg btn-border video-play" href="https://www.youtube.com/watch?v=5BDVH8Ms5h0"><i class="fa fa-play"></i> Watch Video</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5 hidden-sm hidden-xs">
                        <div class="mock right-style">
                            <img class="back-mock wow fadeInRight" data-wow-duration="1.5s" data-wow-delay="1s" src="front/images/mocks/banner-mock-back.png" alt="mock back">
                            <img class="front-mock wow fadeInUp" data-wow-duration="1.5s" src="front/images/mocks/banner-mock-front.png" alt="mock front">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="main-wrap">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="intro-item wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0s">
                            ...
                            <h4 class="intro-title">Quick &amp; efficiency</h4>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="feature wow fadeInUp" data-wow-duration="1.5s">
                        ...
                        <div class="feature-content">
                            <h4 class="feature-title">Custom scrollbars</h4>
                            <p>Messe alias in rerum minima quod quos accusantium officiis</p>
                        </div>
                    </div>
                    <div class="feature wow fadeInUp" data-wow-duration="1.5s">
                        <div class="feature-icon">
                ...
                <div class="col-sm-4 text-center hidden-sm hidden-xs">
                    <div class="mock wow fadeInUp" data-wow-duration="1.5s"><img class="img-responsive" src="front/images/mocks/1.png" alt="..."></div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="feature wow fadeInUp" data-wow-duration="1.5s">
                        <div class="feature-icon">
                        ...
                        <div class="feature-content">
                            <h4 class="feature-title">Tons of API callbacks</h4>
                            <p>Messe alias in rerum minima quod quos accusantium officiis</p>
                        </div>
                    </div>
                    <div class="feature wow fadeInUp" data-wow-duration="1.5s">
                        ...
                        <div class="feature-content">
                            <h4 class="feature-title">Responsive supports</h4>
                            <p>Messe alias in rerum minima quod quos accusantium officiis</p>
                        </div>
                    </div>
                    <div class="feature wow fadeInUp" data-wow-duration="1.5s">
                        ...
                        <div class="feature-content">
                            <h4 class="feature-title">Auto sliding</h4>
                            <p>Messe alias in rerum minima quod quos accusantium officiis</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-3 col-sm-4 text-center">
                    <div class="mock">
                        <img class="back-mock wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.5s" src="front/images/mocks/features-mock-back.png" alt="mock back">
                        <img class="front-mock wow fadeInUp" data-wow-duration="1.5s" src="front/images/mocks/features-mock-front.png" alt="mock front">
                    </div>
                </div>
                <div class="col-lg-6 col-lg-offset-1 col-md-7 col-md-offset-2 col-sm-6 col-sm-offset-2">
                    <div class="section-header style-2">
                        <h2 class="section-title">Extra Crazy Features</h2>
                        <p class="section-subtext">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias temporibus debitis, quia esse alias in rerum minima quod quos accusantium officiis pariatur. </p>
                    </div>
                    <ul class="features icon-list">
                        <li class="extra-feature"><span class="icon-basket"></span>Reliable and Secure Platform</li>
                        <li class="extra-feature"><span class="icon-map"></span>Everything is perfectly organized</li>
                        <li class="extra-feature"><span class="icon-basket"></span>Simple Line Icon</li>
                        <li class="extra-feature"><span class="icon-map"></span>Step on the new level</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3 col-xs-12">
                    <div class="section-header text-center">
                        ...
                        <p class="section-sub">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do ut aliquip</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="screenshot-wrap">
                        <div class="owl-carousel screenshot-carousel" id="screenshot-carousel">
                            <img src="front/images/screenshot/1.jpg" alt="App Screenshot">
                            <img src="front/images/screenshot/2.jpg" alt="App Screenshot">
                            <img src="front/images/screenshot/3.jpg" alt="App Screenshot">
                            <img src="front/images/screenshot/4.jpg" alt="App Screenshot">
                            <img src="front/images/screenshot/5.jpg" alt="App Screenshot">
                            <img src="front/images/screenshot/1.jpg" alt="App Screenshot">
                            <img src="front/images/screenshot/2.jpg" alt="App Screenshot">
                            <img src="front/images/screenshot/3.jpg" alt="App Screenshot">
                            <img src="front/images/screenshot/4.jpg" alt="App Screenshot">
            ...
            <div id="testimonial-carousel" class="testimonial-carousel owl-carousel">
                <div class="testimonial">
                    <div class="commenter-thumb">
                        <img src="front/images/client/client-avatar.png" alt="Client Avatar">
                    </div>
    ...
    <div class="section section-padding">
        <div class="container">
            ...
            <div class="row">
                <a class="client-logo" href="#"><img src="front/images/client/logo-1.png" alt="Client Logo"></a>
                <a class="client-logo" href="#"><img src="front/images/client/logo-2.png" alt="Client Logo"></a>
                <a class="client-logo" href="#"><img src="front/images/client/logo-3.png" alt="Client Logo"></a>
                <a class="client-logo" href="#"><img src="front/images/client/logo-4.png" alt="Client Logo"></a>
                <a class="client-logo" href="#"><img src="front/images/client/logo-5.png" alt="Client Logo"></a>
            </div>
        </div>
    </div>
    <!-- Features In End -->
...
<footer>
    ...
    <div class="logo-social-area section-padding">
        <div class="container text-center">
            <a class="logo logo-footer wow fadeInDown" data-wow-duration="1.5s" href="#">
                <img src="front/images/logo-footer.png" alt="Site Logo">
            </a>
    ...
    <div class="copyright-footer">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xs-12">
                    <p class="copyright">Copyright 2017, <a href="#">Grape</a>. All Right Reserved</p>
                </div>
                <div class="col-md-6 col-xs-12">
                    <ul class="footer-nav">
